...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                 # \n
    prompt_char             #  prompt symbol. Douglas Override (Default: commented)
  )
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=39 # Douglas Override. Default: 31
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=39 # Douglas Override. Default: 39
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%d/%m \uf073  %I:%M:%S %p}'
